...
function toja_register_header_fields() {
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            // Primary CTA (e.g. "Angebote")
            [
                'key' => 'field_toja_header_cta_primary_text',
                'label' => 'Primärer Button Text',
                'name' => 'header_cta_primary_text',
                'type' => 'text',
                'default_value' => 'Angebote',
                'instructions' => 'Text für den primären CTA-Button (z.B. Angebote)',
            ],
            [
                'key' => 'field_toja_header_cta_primary_url',
                'label' => 'Primärer Button URL',
                'name' => 'header_cta_primary_url',
                'type' => 'page_link',
                'instructions' => 'Zielseite für den primären Button',
                'post_type' => ['page'],
                'allow_null' => 1,
            ],
            // Secondary CTA (e.g. "Termin buchen")
            [
                'key' => 'field_toja_header_cta_secondary_text',
                'label' => 'Sekundärer Button Text',
                'name' => 'header_cta_secondary_text',
                'type' => 'text',
                'default_value' => 'Termin buchen',
                'instructions' => 'Text für den sekundären CTA-Button (z.B. Termin buchen)',
            ],
            [
                'key' => 'field_toja_header_cta_secondary_url',
                'label' => 'Sekundärer Button URL',
                'name' => 'header_cta_secondary_url',
                'type' => 'page_link',
                'instructions' => 'Zielseite für den sekundären Button',
                'post_type' => ['page'],
                'allow_null' => 1,
            ],
